  ...
  function renderDrawer(){
    ...
    html += `<div class="dw-sep" style="cursor:default">أدوات</div><div class="dw-group"><a class="dw-link" href="/apartment-tour-v6.html" target="_blank" rel="noopener" style="text-decoration:none"><span class="dw-ico">🏘️</span><span>جولة الشقة</span></a></div>`;
